...
export default function ResponsiveAppBar() {
  ...
  // Example customerId for navigating to details
  const customerId = '12345'; // You should dynamically get the customer ID
      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            ...
            <Button
              key={4}
              onClick={() => router.push(`/customerdetail`)} // Dynamic route for customer details
              sx={{ my: 2, color: 'white', display: 'block' }}
            >
              Customer Details
            </Button>
